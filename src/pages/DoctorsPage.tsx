...
const doctors = [
  ...
  { name: 'Ешмуратов Темур Шерханович',      title: 'д.м.н., профессор',                 position: 'Руководитель профиля Торакальной хирургии и Пульмонологии', exp: 'Стаж более 31 год', photo: doctor3,           filter: 'Хирург'       },
  { name: 'Кусаинов Адилет Шингисович',      title: 'к.м.н. (PhD)',                      position: 'Руководитель профиля ОАРИТ',                               exp: 'Стаж более 33 лет', photo: doctor4,           filter: 'Анестезиолог' },
    ...
    <div className="bg-[#f4f4f4]">
      ...
      <section className="relative overflow-hidden min-h-[600px]">
        ...
        <div className="relative z-10 container-main pt-20 lg:pt-24 pb-28 min-h-[600px] flex flex-col justify-center">
          ...
          {/* Карточка «60+ экспертов» */}
          <div className="bg-[#0a1628]/60 backdrop-blur-sm border border-white/10 rounded-3xl p-6 max-w-sm">
